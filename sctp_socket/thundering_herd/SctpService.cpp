...
private:
    SctpSocket Listeners;
    std::shared_ptr<IoMultiplex> io_multi;
    std::shared_ptr<spdlog::logger> logger;
};


SctpService::SctpService(std::shared_ptr<IoMultiplex> io_multi, std::shared_ptr<spdlog::logger> logger):
    io_multi(io_multi), logger(logger)
{
}

~SctpService::SctpService()
{
}
